...
export default function InspeksiIcsPreview(props: Props) {
  return <div className="pdf-preview flex justify-center bg-slate-100 py-6 print:bg-white print:py-0">
    ...
    <article className="pdf-paper w-[210mm] min-h-[297mm] border-0 bg-white p-7 text-black shadow-2xl print:border-0 print:shadow-none" style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      <div className="mt-8 grid grid-cols-2 text-center text-[10px]"><div><p>Petani</p><p className="mb-10 mt-12">(................................)</p><b>{props.nama || '-'}</b></div><div><p>Petugas ICS</p><p className="mb-10 mt-12">(................................)</p><b>{props.inspektur || '-'}</b></div></div><div className="mt-6 min-h-28 border border-black p-3 text-left text-[10px]"><b>Tanda tangan Komisi persetujuan</b></div><footer className="mt-6 border-t border-black pt-2 text-center text-[8px]">Dokumen hasil wawancara dan verifikasi langsung di lapangan.</footer>
    </article>
  </div>;
}
